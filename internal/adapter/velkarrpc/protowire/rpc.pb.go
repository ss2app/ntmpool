...
//
// Clients are expected to build RequestMessages and wrap them in VelkardMessage. (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a VelkardMessage) the RPC server will respond with a
// ResponseMessage (likewise wrapped in a VelkardMessage) respective to the original RequestMessage.
//
//
...
type RpcUtxoEntry struct {
	...
	CovenantId      string                 `protobuf:"bytes,6,opt,name=covenant_id,json=covenantId,proto3" json:"covenant_id,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RpcUtxoEntry) GetCovenantId() string {
	if x != nil {
		return x.CovenantId
	}
	return ""
...
// GetCurrentNetworkRequestMessage requests the network velkard is currently running against.
//
...
type GetBlockTemplateRequestMessage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Which velkar address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether velkard thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when velkard is not synced.
	// That is because when velkard isn't in sync with the rest of the network there's a high
...
// GetPeerAddressesRequestMessage requests the list of known velkard addresses in the
...
// currently connected to this velkard.
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this velkard initiated the connection
	...
	// The timestamp of when this peer connected to this velkard
...
// AddPeerRequestMessage adds a peer to velkard's outgoing connection list.
// This will, in most cases, result in velkard connecting to said peer.
...
// parent chain from some startHash to this velkard's current virtual
...
// GetBlockCountRequestMessage requests the current number of blocks in this velkard.
...
// ShutDownRequestMessage shuts down this velkard.
...
//
// This call is only available when this velkard was started with `--utxoindex`
//
...
// GetUtxosByAddressesRequestMessage requests all current UTXOs for the given velkard addresses
//
// This call is only available when this velkard was started with `--utxoindex`
...
const file_rpc_proto_rawDesc = "" +
	...
	"\x05index\x18\x02 \x01(\rR\x05index\"\xd6\x01\n" +
	...
	"\x05error\x18\xe8\a \x01(\v2\x13.protowire.RPCErrorR\x05error\"3\n" +
	...
	"\x05error\x18\xe8\a \x01(\v2\x13.protowire.RPCErrorR\x05error\"!\n" +
	"\x1fGetMempoolEntriesRequestMessage\"\x81\x01\n" +
	...
	"\vtransaction\x18\x03 \x01(\v2\x19.protowire.RpcTransactionR\vtransaction\"$\n" +
	...
	"\x05error\x18\xe8\a \x01(\v2\x13.protowire.RPCErrorR\x05error\"7\n" +
	"5NotifyVirtualSelectedParentChainChangedRequestMessage\"d\n" +
	"6NotifyVirtualSelectedParentChainChangedResponseMessage\x12*\n" +
	"\x05error\x18\xe8\a \x01(\v2\x13.protowire.RPCErrorR\x05error\"\xa6\x01\n" +
	...
	"\x15addedChainBlockHashes\x18\x03 \x03(\tR\x15addedChainBlockHashes\"^\n" +
	...
	"\tstartHash\x18\x01 \x01(\tR\tstartHash\"\xd3\x01\n" +
	"5GetVirtualSelectedParentChainFromBlockResponseMessage\x128\n" +
	"\x17removedChainBlockHashes\x18\x01 \x03(\tR\x17removedChainBlockHashes\x124\n" +
	"\x15addedChainBlockHashes\x18\x03 \x03(\tR\x15addedChainBlockHashes\x12*\n" +
	...
	"\x15GetInfoRequestMessage\"\xa2\x01\n" +
	...
	"\x05error\x18\xe8\a \x01(\v2\x13.protowire.RPCErrorR\x05error\"%\n" +
	"#NewBlockTemplateNotificationMessageb\x06proto3"
...
var file_rpc_proto_goTypes = []any{
	...
	(*NotifyNewBlockTemplateRequestMessage)(nil),                       // 96: protowire.NotifyNewBlockTemplateRequestMessage
...
var file_rpc_proto_depIdxs = []int32{
	...
	11, // 51: protowire.UtxosByAddressesEntry.outpoint:type_name -> protowire.RpcOutpoint
	12, // 52: protowire.UtxosByAddressesEntry.utxoEntry:type_name -> protowire.RpcUtxoEntry
	...
	1,  // 65: protowire.NotifyNewBlockTemplateResponseMessage.error:type_name -> protowire.RPCError
