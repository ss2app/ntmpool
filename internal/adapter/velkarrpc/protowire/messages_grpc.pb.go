...
type P2PClient interface {
	MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[VelkardMessage, VelkardMessage], error)
}
...
func (c *p2PClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[VelkardMessage, VelkardMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &P2P_ServiceDesc.Streams[0], P2P_MessageStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[VelkardMessage, VelkardMessage]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamClient = grpc.BidiStreamingClient[VelkardMessage, VelkardMessage]

// P2PServer is the server API for P2P service.
// All implementations must embed UnimplementedP2PServer
// for forward compatibility.
type P2PServer interface {
	MessageStream(grpc.BidiStreamingServer[VelkardMessage, VelkardMessage]) error
...
func (UnimplementedP2PServer) MessageStream(grpc.BidiStreamingServer[VelkardMessage, VelkardMessage]) error {
...
func _P2P_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(P2PServer).MessageStream(&grpc.GenericServerStream[VelkardMessage, VelkardMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamServer = grpc.BidiStreamingServer[VelkardMessage, VelkardMessage]
...
func (c *rPCClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[VelkardMessage, VelkardMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamClient = grpc.BidiStreamingClient[VelkardMessage, VelkardMessage]
...
func (UnimplementedRPCServer) MessageStream(grpc.BidiStreamingServer[VelkardMessage, VelkardMessage]) error {
	return status.Error(codes.Unimplemented, "method MessageStream not implemented")
}
...
func _RPC_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RPCServer).MessageStream(&grpc.GenericServerStream[VelkardMessage, VelkardMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamServer = grpc.BidiStreamingServer[VelkardMessage, VelkardMessage]
